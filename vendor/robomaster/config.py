...
DEFAULT_CONN_PROTO = DEFAULT_PROTO_TYPE # Fix for client.py missing attribute
...
ROBOT_DEFAULT_LOCAL_RNDIS_ADDR = ('0.0.0.0', ROBOT_SDK_PORT_MIN)
ROBOT_DEFAULT_LOCAL_WIFI_ADDR = ('0.0.0.0', ROBOT_SDK_PORT_MIN)
